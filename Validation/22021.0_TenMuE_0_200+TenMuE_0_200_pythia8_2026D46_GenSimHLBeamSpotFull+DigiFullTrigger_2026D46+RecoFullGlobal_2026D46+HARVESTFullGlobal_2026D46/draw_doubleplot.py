...
def draw_compare(me, filesys_dir, compareme):
    ...
    if me_class_name == 'TH1F':
        ...
        #scale = compareme.GetMaximum()
        scale = me.GetMaximum()
        me.SetMaximum(scale*1.2)
        me.Draw('sames hist')
...
def main():
	...
	#stand!!!!
    parser.add_argument('-i2', '--in-compare', type=str, default='/cms/ldap_home/seungjun/Before_CMSSW_11_1_0_pre3/src/Validation/22021.0_TenMuE_0_200+TenMuE_0_200_pythia8_2026D46_GenSimHLBeamSpotFull+DigiFullTrigger_2026D46+RecoFullGlobal_2026D46+HARVESTFullGlobal_2026D46/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root')
